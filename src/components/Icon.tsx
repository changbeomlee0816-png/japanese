...
export type IconName =
  ...
  | 'walk' | 'train' | 'car' | 'bike' | 'plane' | 'ferry' | 'bus'
...
const PATHS: Record<IconName, string> = {
  ...
  plane: 'M10.3 20.5 12 15.2l4.6-1.3 3.6 6.1 1.6-.5-2.2-6.7 1.6-.5a2.1 2.1 0 0 0 1.4-2.6 2.1 2.1 0 0 0-2.6-1.4l-1.6.5L14.6 2l-1.6.5.6 7-4.6 1.3-2.2-3-1.6.5.9 3.6-1.9 2 .5 1.6 2.6-.8 1.4 3.4 1.6-.6Z',
  ferry: 'M3.5 18.5c1.3 0 1.3 1 2.6 1s1.3-1 2.6-1 1.3 1 2.6 1 1.3-1 2.6-1 1.3 1 2.6 1 1.3-1 2.6-1M4.8 15.2 6 10.5h12l1.2 4.7M8.5 10.5V6h7v4.5M11 6V3.5h2V6',
  bus: 'M5.5 4.5h13a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-13a2 2 0 0 1-2-2v-9a2 2 0 0 1 2-2Zm-2 5h17M8 13.5h.01M16 13.5h.01M7 17.5V20m10-2.5V20',
