...
export const POI: PoiEntry[] = [
  ...
  { name: '아사쿠사 센소지', coord: { lat: 35.7148, lng: 139.7967 }, area: '도쿄', regionId: 'tokyo', category: 'sight', stayMin: 90, top: true, blurb: '도쿄에서 가장 오래된 절. 가미나리몬과 나카미세 거리', tags: ['역사', '사진'], aliases: ['아사쿠사', 'asakusa', 'sensoji', '센소지', '浅草', '雷門', '가미나리몬'] },
  ...
  { name: '도쿄 스카이트리', coord: { lat: 35.7101, lng: 139.8107 }, area: '도쿄', regionId: 'tokyo', category: 'sight', stayMin: 90, top: true, blurb: '634m 전망대. 해질녘 티켓은 미리 예약', tags: ['전망', '야경'], aliases: ['스카이트리', 'skytree', 'スカイツリー'] },
  { name: '메이지 신궁', coord: { lat: 35.6764, lng: 139.6993 }, area: '도쿄', regionId: 'tokyo', category: 'sight', stayMin: 70, blurb: '도심 한복판의 울창한 숲길. 아침이 조용하다', tags: ['자연', '역사'], aliases: ['메이지신궁', 'meiji shrine', '明治神宮'] },
  ...
  { name: '도쿄 타워', coord: { lat: 35.6586, lng: 139.7454 }, area: '도쿄', regionId: 'tokyo', category: 'sight', stayMin: 70, blurb: '스카이트리보다 낮지만 시내가 더 가깝게 보인다', tags: ['전망', '야경'], aliases: ['도쿄타워', 'tokyo tower', '東京タワー'] },
  ...
  { name: '츠키지 장외시장', coord: { lat: 35.6654, lng: 139.7707 }, area: '도쿄', regionId: 'tokyo', category: 'food', stayMin: 80, top: true, blurb: '아침 해산물과 계란말이. 오후엔 대부분 닫는다', tags: ['시장', '아침'], aliases: ['츠키지', 'tsukiji', '築地'] },
  { name: '도요스 시장', coord: { lat: 35.6449, lng: 139.786 }, area: '도쿄', regionId: 'tokyo', category: 'food', stayMin: 90, blurb: '참치 경매를 볼 수 있는 새 수산시장. 예약 필요', tags: ['시장', '아침'], aliases: ['도요스', 'toyosu', '豊洲'] },
  ...
  { name: '신주쿠 교엔', coord: { lat: 35.6852, lng: 139.71 }, area: '도쿄', regionId: 'tokyo', category: 'sight', stayMin: 80, blurb: '넓고 잘 가꾼 정원. 벚꽃과 단풍 모두 좋다', tags: ['자연'], aliases: ['신주쿠교엔', 'shinjuku gyoen', '新宿御苑'] },
  ...
  { name: '도쿄 디즈니랜드', coord: { lat: 35.6329, lng: 139.8804 }, area: '도쿄', regionId: 'tokyo', category: 'activity', stayMin: 480, blurb: '하루를 통째로 비워야 한다. 티켓은 날짜 지정', tags: ['가족'], aliases: ['디즈니랜드', 'disneyland', 'ディズニーランド'] },
  { name: '팀랩 플래닛 도쿄', coord: { lat: 35.6497, lng: 139.79 }, area: '도쿄', regionId: 'tokyo', category: 'activity', stayMin: 90, blurb: '맨발로 물에 들어가는 디지털 아트. 예약 필수', tags: ['전시', '사진'], aliases: ['팀랩', 'teamlab', 'チームラボ'] },
  ...
  { name: '지브리 미술관', coord: { lat: 35.6962, lng: 139.5704 }, area: '도쿄', regionId: 'tokyo', category: 'activity', stayMin: 120, blurb: '한 달 전 예약 필수. 사진 촬영 금지', tags: ['가족', '전시'], aliases: ['ghibli', '지브리', 'ジブリ美術館'] },

  // ── 교토 ─────────────────────────────────────────────
  { name: '교토역', coord: { lat: 34.9858, lng: 135.7588 }, area: '교토', regionId: 'kyoto', category: 'transport', stayMin: 40, aliases: ['kyoto station', '京都駅'] },
  { name: '기요미즈데라', coord: { lat: 34.9949, lng: 135.785 }, area: '교토', regionId: 'kyoto', category: 'sight', stayMin: 90, top: true, blurb: '절벽에 걸친 목조 무대. 언덕길 상점가와 함께 걷는다', tags: ['역사', '사진'], aliases: ['청수사', 'kiyomizu', '清水寺', '기요미즈'] },
  { name: '후시미 이나리 신사', coord: { lat: 34.9671, lng: 135.7727 }, area: '교토', regionId: 'kyoto', category: 'sight', stayMin: 100, top: true, blurb: '붉은 토리이가 산으로 이어진다. 이른 아침이 한산', tags: ['사진', '등산'], aliases: ['후시미이나리', 'fushimi inari', '伏見稲荷', '천개의토리이'] },
  ...
  { name: '킨카쿠지', coord: { lat: 35.0394, lng: 135.7292 }, area: '교토', regionId: 'kyoto', category: 'sight', stayMin: 60, top: true, blurb: '금박을 입힌 누각이 연못에 비친다', tags: ['역사', '사진'], aliases: ['금각사', 'kinkakuji', '金閣寺'] },
  { name: '긴카쿠지', coord: { lat: 35.027, lng: 135.7982 }, area: '교토', regionId: 'kyoto', category: 'sight', stayMin: 70, blurb: '소박한 정원. 철학의 길과 이어 걷기 좋다', tags: ['자연', '산책'], aliases: ['은각사', 'ginkakuji', '銀閣寺'] },
  ...
  { name: '니시키 시장', coord: { lat: 35.005, lng: 135.7648 }, area: '교토', regionId: 'kyoto', category: 'food', stayMin: 70, top: true, blurb: '400년 된 부엌. 서서 먹는 주전부리가 많다', tags: ['시장'], aliases: ['니시키시장', 'nishiki', '錦市場'] },
  { name: '니조성', coord: { lat: 35.0142, lng: 135.7481 }, area: '교토', regionId: 'kyoto', category: 'sight', stayMin: 80, blurb: '밟으면 소리 나는 마루. 쇼군의 교토 거처', tags: ['역사'], aliases: ['nijo castle', '二条城'] },
  ...
  { name: '헤이안 신궁', coord: { lat: 35.016, lng: 135.7823 }, area: '교토', regionId: 'kyoto', category: 'sight', stayMin: 60, aliases: ['헤이안신궁', 'heian', '平安神宮'] },
  ...
  { name: '오사카성', coord: { lat: 34.6873, lng: 135.5262 }, area: '오사카', regionId: 'osaka', category: 'sight', stayMin: 90, top: true, blurb: '천수각과 넓은 공원. 벚꽃철에 특히 붐빈다', tags: ['역사', '자연'], aliases: ['osaka castle', '大阪城'] },
  { name: '구로몬 시장', coord: { lat: 34.6657, lng: 135.5062 }, area: '오사카', regionId: 'osaka', category: 'food', stayMin: 70, top: true, blurb: '해산물을 그 자리에서 구워 준다. 오전이 신선', tags: ['시장'], aliases: ['구로몬시장', 'kuromon', '黒門市場'] },
  { name: '유니버설 스튜디오 재팬', coord: { lat: 34.6654, lng: 135.4323 }, area: '오사카', regionId: 'osaka', category: 'activity', stayMin: 480, blurb: '하루 통째로. 익스프레스 패스는 미리 사두면 편하다', tags: ['가족'], aliases: ['usj', 'universal', '유니버셜', 'ユニバ'] },
  ...
  // ── 나라 · 고베 ──────────────────────────────────────
  { name: '나라 공원', coord: { lat: 34.6851, lng: 135.843 }, area: '나라', regionId: 'nara', category: 'sight', stayMin: 120, top: true, blurb: '사슴이 자유롭게 다닌다. 센베는 사자마자 몰려든다', tags: ['자연', '가족'], aliases: ['나라', 'nara', '奈良', '사슴공원'] },
  { name: '도다이지', coord: { lat: 34.689, lng: 135.8398 }, area: '나라', regionId: 'nara', category: 'sight', stayMin: 70, top: true, blurb: '세계 최대급 목조 건물과 대불', tags: ['역사'], aliases: ['동대사', 'todaiji', '東大寺'] },
  ...
  { name: '히메지성', coord: { lat: 34.8394, lng: 134.6939 }, area: '히메지', regionId: 'kobe', category: 'sight', stayMin: 120, blurb: '원형 그대로 남은 백로성. 오사카에서 1시간', tags: ['역사'], aliases: ['히메지', 'himeji', '姫路城'] },
  ...
  { name: '오와쿠다니', coord: { lat: 35.2443, lng: 139.0195 }, area: '하코네', regionId: 'hakone', category: 'sight', stayMin: 60, top: true, blurb: '화산 연기와 검은 달걀. 로프웨이로 오른다', tags: ['자연'], aliases: ['owakudani', '大涌谷'] },
  ...
  { name: '니조 시장', coord: { lat: 43.0578, lng: 141.3549 }, area: '삿포로', regionId: 'sapporo', category: 'food', stayMin: 60, blurb: '아침 해산물 덮밥. 성게와 연어알이 유명', tags: ['시장', '아침'], aliases: ['니조시장', 'nijo market', '二条市場'] },
  ...
  { name: '나카스 포장마차 거리', coord: { lat: 33.593, lng: 130.406 }, area: '후쿠오카', regionId: 'fukuoka', category: 'food', stayMin: 90, top: true, blurb: '해 지면 강변에 야타이가 늘어선다. 현금 준비', tags: ['야경', '먹거리'], aliases: ['나카스', 'nakasu', '中洲', '야타이'] },
  { name: '다자이후 텐만구', coord: { lat: 33.5215, lng: 130.535 }, area: '후쿠오카', regionId: 'fukuoka', category: 'sight', stayMin: 90, top: true, blurb: '학문의 신을 모신 신사. 참배길 매화떡이 명물', tags: ['역사'], aliases: ['다자이후', 'dazaifu', '太宰府'] },
  ...
  { name: '벳푸 지옥순례', coord: { lat: 33.2794, lng: 131.5006 }, area: '오이타', regionId: 'yufuin', category: 'sight', stayMin: 150, blurb: '색이 다른 온천 웅덩이 일곱 곳을 도는 코스', tags: ['온천'], aliases: ['벳푸', 'beppu', '別府'] },
  ...
  { name: '히로시마 평화기념공원', coord: { lat: 34.3955, lng: 132.4536 }, area: '히로시마', regionId: 'hiroshima', category: 'sight', stayMin: 120, top: true, blurb: '원폭 돔과 자료관. 시간을 넉넉히 두는 편이 좋다', tags: ['역사'], aliases: ['히로시마', 'hiroshima', '平和記念公園'] },
  { name: '미야지마 이쓰쿠시마 신사', coord: { lat: 34.296, lng: 132.3197 }, area: '히로시마', regionId: 'hiroshima', category: 'sight', stayMin: 180, top: true, blurb: '바다 위에 뜬 붉은 도리이. 페리로 10분', tags: ['사진', '자연'], aliases: ['미야지마', 'miyajima', '厳島神社'] },
  { name: '겐로쿠엔', coord: { lat: 36.562, lng: 136.6624 }, area: '가나자와', regionId: 'kanazawa', category: 'sight', stayMin: 90, top: true, blurb: '일본 3대 정원. 계절마다 표정이 완전히 다르다', tags: ['자연'], aliases: ['가나자와', 'kanazawa', 'kenrokuen', '兼六園'] },
  ...
  { name: '츄라우미 수족관', coord: { lat: 26.6944, lng: 127.8779 }, area: '오키나와', regionId: 'okinawa', category: 'activity', stayMin: 180, top: true, blurb: '거대 수조의 고래상어. 나하에서 차로 2시간', tags: ['가족'], aliases: ['츄라우미', 'churaumi', '美ら海水族館'] },
